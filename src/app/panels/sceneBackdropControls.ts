import { choice, color, segmented, slider, toggle } from '@/ui/controls'
...
export const backdropControls: readonly Control<AppState>[] = [
...
export const pedestalControls: readonly Control<AppState>[] = [
  toggle({
    label: 'Show',
